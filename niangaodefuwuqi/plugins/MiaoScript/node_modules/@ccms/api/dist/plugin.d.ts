export declare namespace plugin {
     ...
     */
    const PluginFolder: unique symbol;
    /**
     * Runtime Plugin Instance
     */
    const PluginInstance: unique symbol;
    /**
    ...
    const PluginScanner: unique symbol;
    /**
     * 插件加载元信息
     */
    ...
    const PluginLoader: unique symbol;
    /**
     * 插件加载器
     */
    ...
    interface PluginMetadata extends BaseMetadata {
        /**
         * 插件名称 不填默认为类名
         */
        name: string;
